    ...
    return (
        <>
            ...
            <div className="mb-2 text-center">
                <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-slate-900 font-bold text-white text-xl shadow-sm">
                    {activeTenant?.name ? activeTenant.name.charAt(0) : 'W'}
                </div>
                <h1 className="text-xl font-bold tracking-tight text-slate-900">
                    {activeTenant?.name || 'Warehouse Operations'}
                </h1>
            </div>
                    ...
                    <>
                        ...
                        {canRegister && (
                            <div className="text-center text-sm text-muted-foreground">
                                ...
                                <TextLink href={`/${activeTenant?.slug}/register`} tabIndex={5}>
                                    Sign up
                                </TextLink>
                            </div>
                        )}
